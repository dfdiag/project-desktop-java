...
public class edit_statistik extends javax.swing.JFrame {

    /**
     * Creates new form input_jasa
     */
    public edit_statistik() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txt_cari.setFont(new java.awt.Font("Rockwell", 0, 12)); // NOI18N
        jPanel2.add(txt_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 80, 150, 20));
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 120, 110, -1));
        ...
        jPanel2.add(btn_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 80, 90, 20));
        ...
        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 390, -1, -1));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel8.setText("Statistik");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 90, 40));
    ...
    private void btn_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cariActionPerformed
       ...
       try {
            ...
            java.sql.ResultSet res = stm.executeQuery("SELECT * FROM statistik " + " WHERE No='" + txt_cari.getText() + "'");
            if (res.next()) {
                btn_submit.setEnabled(true);
                txt_barang1.setText(res.getString("nama_barang"));
                txt_tanggal.setText(res.getString("tanggal"));
                txt_pemasukan.setText(res.getString("biaya_pemasukan"));
                txt_pengeluaran.setText(res.getString("biaya_pengeluaran"));
                txt_PendapatanBersih.setText(res.getString("pendapatan_bersih"));
            } else {
                JOptionPane.showMessageDialog(this, "NO Tidak ada");
                btn_submit.setEnabled(false);
                txt_barang1.setText("");
                txt_tanggal.setText("");
                txt_pemasukan.setText("");
                txt_pengeluaran.setText("");
                txt_pengeluaran.setText("");
                txt_PendapatanBersih.setText("");
            }
    ...
    private void btn_submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submitActionPerformed
        // TODO add your handling code here:
        try {
            String sql = " UPDATE statistik SET tanggal='" + txt_tanggal.getText() + "',"
                    + "nama_barang='" + txt_barang1.getText() + "',"
                    + "biaya_pengeluaran='" + txt_pengeluaran.getText() + "',"
                    + "biaya_pemasukan='" + txt_pemasukan.getText() + "',"
                    + "pendapatan_bersih='" + txt_PendapatanBersih.getText() + "'"
                    + "WHERE statistik.no='" + txt_cari.getText() + "'";
            java.sql.Connection conn = (Connection) Connect.ConfigDB();
