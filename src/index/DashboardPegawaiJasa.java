...
public class DashboardPegawaiJasa extends javax.swing.JFrame {
    ...
    private void showTable() {
        ...
        tabelcd.addColumn("Tanggal terima");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1260, 170, -1, 30));
        ...
        getContentPane().add(txt_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 170, 220, 30));
        ...
        getContentPane().add(btn_cetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 130, 80, 30));
        ...
        getContentPane().add(btn_edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 680, -1, -1));
        ...
        getContentPane().add(btn_hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 680, -1, -1));
        ...
        btn_jasa.setBackground(new java.awt.Color(204, 255, 255));
        ...
        getContentPane().add(btn_re, new org.netbeans.lib.awtextra.AbsoluteConstraints(1230, 130, 90, 30));
    ...
    private void btn_jasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_jasaActionPerformed
        btn_jasa.setEnabled(false); // tombol di disable
